 ...
 */
public class SessionHandlerImplApp implements SessionHandler {

    private static final Logger log = LoggerFactory.getLogger(SessionHandlerImplApp.class);
    ...
    public SessionHandlerImplApp(String sessionCookieName, long sessionTimeout, boolean nagHttps, SessionStore sessionStore) {
    ...
    public static SessionHandler createApp(SessionStore sessionStore,String name ) {
        return new SessionHandlerImplApp(name, 15552000000l, DEFAULT_NAG_HTTPS, sessionStore);
    }
